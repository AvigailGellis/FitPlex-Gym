...
insert member(FirstName, LastName, ContactNumber, EmergencyContactNumber, InitialWeight, GoalWeight, CurrentWeight, BMI, MembershipStartDate, MembershipEndDate, MembershipType, PaymentStatus, SessionDateAndTime)
